...
@SAMPLE_QUESTIONS = [
  {
    soundfile_prefix: 'EM-Finale_DK-DE',
    correct_answer: 'A',
    alternatives: [
        {
            name: 'A',
  ...
  {
    soundfile_prefix: 'EM-Kval_DK-GB',
    correct_answer: 'B',
    alternatives: [
        {
            name: 'A',
  ...
  {
    soundfile_prefix: 'EM-Semi_DK-NL',
    correct_answer: 'C',
    alternatives: [
        {
            name: 'A',
  ...
  {
    soundfile_prefix: 'OL-Semi_DK-HU',
    correct_answer: 'D',
    alternatives: [
        {
            name: 'A',
  ...
  {
    soundfile_prefix: 'VM-Kvart_DK-BR',
    correct_answer: 'A',
    alternatives: [
        {
            name: 'A',
